...
const ENTITY_CONFIG = {
  ...
  perka: {
    ...
    tableColumnGroups: [
      ...
      { label: 'Stasiun C', colspan: 2 },
      { label: 'Stasiun D', colspan: 2 },
      { label: 'Stasiun E', colspan: 2 },
      { label: 'Keterangan', rowspan: 2 },
    ],
    tableColumnGroupsRow2: ['Datang', 'Berangkat', 'Datang', 'Berangkat', 'Datang', 'Berangkat', 'Datang', 'Berangkat', 'Datang', 'Berangkat'],
    tableColumns: [
      { key: 'nomorKA', label: 'Nomor KA' },
      ...
      { key: 'stasiunCDatang', label: 'C - Datang', isTime: true, sameAsKey: 'stasiunCBerangkat' },
      { key: 'stasiunCBerangkat', label: 'C - Berangkat', isTime: true },
