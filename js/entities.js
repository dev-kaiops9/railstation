...
const ENTITY_CONFIG = {
  ...
  perka: {
    label: 'Daftar Waktu', labelSingular: 'Perka',
    searchKeys: ['nomorKA', 'namaKA', 'relasi'],
    // Header 2 baris (baris atas dikelompokkan per stasiun, baris bawah Datang/Berangkat)
    // dipakai untuk tampilan tabel view (lihat mountInlineTableCard).
    tableColumnGroups: [
      { label: 'Nomor KA', rowspan: 2 },
      { label: 'Nama KA', rowspan: 2 },
      { label: 'Relasi', rowspan: 2 },
      { label: 'Stasiun A', colspan: 2 },
      { label: 'Stasiun B', colspan: 2 },
      { label: 'Stasiun C', colspan: 2, highlight: true },
      { label: 'Stasiun D', colspan: 2 },
      { label: 'Stasiun E', colspan: 2 },
      { label: 'Keterangan', rowspan: 2 },
    ],
    tableColumnGroupsRow2: [
      { label: 'Datang' }, { label: 'Berangkat' },
      { label: 'Datang' }, { label: 'Berangkat' },
      { label: 'Datang', highlight: true }, { label: 'Berangkat', highlight: true },
      { label: 'Datang' }, { label: 'Berangkat' },
      { label: 'Datang' }, { label: 'Berangkat' },
    ],
    tableColumns: [
      { key: 'nomorKA', label: 'Nomor KA' },
      { key: 'namaKA', label: 'Nama KA' },
      { key: 'relasi', label: 'Relasi' },
      { key: 'stasiunADatang', label: 'A - Datang', isTime: true, sameAsKey: 'stasiunABerangkat' },
      { key: 'stasiunABerangkat', label: 'A - Berangkat', isTime: true },
      { key: 'stasiunBDatang', label: 'B - Datang', isTime: true, sameAsKey: 'stasiunBBerangkat' },
      { key: 'stasiunBBerangkat', label: 'B - Berangkat', isTime: true },
      { key: 'stasiunCDatang', label: 'C - Datang', isTime: true, sameAsKey: 'stasiunCBerangkat', highlight: true },
      { key: 'stasiunCBerangkat', label: 'C - Berangkat', isTime: true, highlight: true },
      { key: 'stasiunDDatang', label: 'D - Datang', isTime: true, sameAsKey: 'stasiunDBerangkat' },
      { key: 'stasiunDBerangkat', label: 'D - Berangkat', isTime: true },
      { key: 'stasiunEDatang', label: 'E - Datang', isTime: true, sameAsKey: 'stasiunEBerangkat' },
      { key: 'stasiunEBerangkat', label: 'E - Berangkat', isTime: true },
      { key: 'keterangan', label: 'Keterangan' },
    ],
    fields: [
      { key: 'nomorKA', label: 'Nomor KA', type: 'text', required: true },
      { key: 'namaKA', label: 'Nama KA', type: 'text' },
      { key: 'relasi', label: 'Relasi', type: 'text' },
      { key: 'stasiunADatang', label: 'A - Datang', type: 'time' },
      { key: 'stasiunABerangkat', label: 'A - Berangkat', type: 'time' },
      { key: 'stasiunBDatang', label: 'B - Datang', type: 'time' },
      { key: 'stasiunBBerangkat', label: 'B - Berangkat', type: 'time' },
      { key: 'stasiunCDatang', label: 'C - Datang', type: 'time' },
      { key: 'stasiunCBerangkat', label: 'C - Berangkat', type: 'time' },
      { key: 'stasiunDDatang', label: 'D - Datang', type: 'time' },
      { key: 'stasiunDBerangkat', label: 'D - Berangkat', type: 'time' },
      { key: 'stasiunEDatang', label: 'E - Datang', type: 'time' },
      { key: 'stasiunEBerangkat', label: 'E - Berangkat', type: 'time' },
      { key: 'keterangan', label: 'Keterangan', type: 'text' },
    ],
  },
  jalur: {
