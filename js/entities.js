...
const ENTITY_CONFIG = {
  ...
  perka: {
    label: 'Daftar Waktu', labelSingular: 'Daftar Waktu',
    searchKeys: ['nomorKA', 'namaKA', 'relasi'],
    tableClass: 'daftar-waktu-table',
    headerRows: [
      [
    ...
    tableColumns: [
      ...
      { key: 'stasiunADatang', label: 'DATANG' },
      { key: 'stasiunABerangkat', label: 'BERANGKAT' },
      { key: 'stasiunBDatang', label: 'DATANG' },
      { key: 'stasiunBBerangkat', label: 'BERANGKAT' },
      { key: 'stasiunCDatang', label: 'DATANG' },
      { key: 'stasiunCBerangkat', label: 'BERANGKAT' },
      { key: 'stasiunDDatang', label: 'DATANG' },
      { key: 'stasiunDBerangkat', label: 'BERANGKAT' },
      { key: 'stasiunEDatang', label: 'DATANG' },
      { key: 'stasiunEBerangkat', label: 'BERANGKAT' },
      { key: 'keterangan', label: 'KETERANGAN' },
    ],
    fields: [
      { key: 'nomorKA', label: 'NOMOR KA', type: 'text', required: true },
      ...
      { key: 'stasiunADatang', label: 'STASIUN A — DATANG', type: 'time' },
      { key: 'stasiunABerangkat', label: 'STASIUN A — BERANGKAT', type: 'time' },
      { key: 'stasiunBDatang', label: 'STASIUN B — DATANG', type: 'time' },
      { key: 'stasiunBBerangkat', label: 'STASIUN B — BERANGKAT', type: 'time' },
      { key: 'stasiunCDatang', label: 'STASIUN C — DATANG', type: 'time' },
      { key: 'stasiunCBerangkat', label: 'STASIUN C — BERANGKAT', type: 'time' },
      { key: 'stasiunDDatang', label: 'STASIUN D — DATANG', type: 'time' },
      { key: 'stasiunDBerangkat', label: 'STASIUN D — BERANGKAT', type: 'time' },
      { key: 'stasiunEDatang', label: 'STASIUN E — DATANG', type: 'time' },
      { key: 'stasiunEBerangkat', label: 'STASIUN E — BERANGKAT', type: 'time' },
      { key: 'keterangan', label: 'KETERANGAN', type: 'text' },
    ],
  },
  jalur: {
