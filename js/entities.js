...
const ENTITY_CONFIG = {
  ...
  perka: {
    ...
    tableColumns: [
      ...
      { key: 'stasiunADatang', label: 'A - Datang' },
      { key: 'stasiunABerangkat', label: 'A - Berangkat' },
      { key: 'stasiunBDatang', label: 'B - Datang' },
      { key: 'stasiunBBerangkat', label: 'B - Berangkat' },
      { key: 'stasiunCDatang', label: 'C - Datang' },
      { key: 'stasiunCBerangkat', label: 'C - Berangkat' },
      { key: 'stasiunDDatang', label: 'D - Datang' },
      { key: 'stasiunDBerangkat', label: 'D - Berangkat' },
      { key: 'stasiunEDatang', label: 'E - Datang' },
      { key: 'stasiunEBerangkat', label: 'E - Berangkat' },
      { key: 'keterangan', label: 'Keterangan' },
    ],
    fields: [
      { key: 'nomorKA', label: 'Nomor KA', type: 'text', required: true },
