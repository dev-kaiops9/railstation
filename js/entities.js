...
const ENTITY_CONFIG = {
  ...
  keteranganDinasan: {
    label: 'Keterangan Dinasan', labelSingular: 'Keterangan Dinasan',
    searchKeys: ['kode', 'keterangan'],
    tableColumns: [
      { key: 'kode', label: 'Kode' },
      { key: 'keterangan', label: 'Keterangan' },
    ],
  ...
  ijk: {
    label: 'Ikhtisar Jam Kerja (IJK)', labelSingular: 'IJK',
    searchKeys: ['kode', 'dinas'],
    tableColumns: [
      { key: 'kode', label: 'Kode' },
      { key: 'dinas', label: 'Dinas' },
      { key: 'mulaiDinas', label: 'Mulai Dinas' },
      { key: 'akhirDinas', label: 'Akhir Dinas' },
      { key: 'status', label: 'Status' },
    ],
    fields: [
      { key: 'kode', label: 'Kode', type: 'text', required: true },
      { key: 'dinas', label: 'Dinas', type: 'text' },
      { key: 'mulaiDinas', label: 'Mulai Dinas', type: 'time' },
      { key: 'akhirDinas', label: 'Akhir Dinas', type: 'time' },
      { key: 'status', label: 'Status', type: 'text' },
    ],
  },
  kebutuhanPegawai: {
    label: 'Kebutuhan Pegawai', labelSingular: 'Kebutuhan Pegawai',
    searchKeys: ['jabatan'],
    tableColumns: [
      { key: 'jabatan', label: 'Jabatan' },
      { key: 'kebutuhan', label: 'Kebutuhan' },
      { key: 'adanya', label: 'Adanya' },
    ...
    fields: [
      ...
      { key: 'adanya', label: 'Adanya', type: 'number' },
      { key: 'kurang', label: 'Kurang', type: 'number' },
      { key: 'lebih', label: 'Lebih', type: 'number' },
    ],
  },
  sertifikasi: {
    label: 'Sertifikasi', labelSingular: 'Sertifikasi',
    searchKeys: ['nama', 'noSertifikasi', 'kategori'],
    tableColumns: [
      { key: 'nama', label: 'Nama' },
      { key: 'noSertifikasi', label: 'No. Sertifikasi' },
      { key: 'kategori', label: 'Kategori' },
      { key: 'masaBerlaku', label: 'Masa Berlaku', isDate: true },
    ],
    fields: [
      { key: 'nama', label: 'Nama', type: 'text', required: true },
      { key: 'noSertifikasi', label: 'No. Sertifikasi', type: 'text' },
      { key: 'kategori', label: 'Kategori', type: 'text' },
      { key: 'masaBerlaku', label: 'Masa Berlaku', type: 'date' },
    ],
  },
  kecakapan: {
    label: 'Tanda Kecakapan', labelSingular: 'Kecakapan',
    searchKeys: ['nama', 'kecakapanStasiun', 'kategori'],
    tableColumns: [
      { key: 'nama', label: 'Nama' },
      { key: 'kecakapanStasiun', label: 'Kecakapan Stasiun' },
      { key: 'kategori', label: 'Kategori' },
      { key: 'masaBerlaku', label: 'Masa Berlaku', isDate: true },
    ],
    fields: [
      { key: 'nama', label: 'Nama', type: 'text', required: true },
      { key: 'kecakapanStasiun', label: 'Kecakapan Stasiun', type: 'text' },
      { key: 'kategori', label: 'Kategori', type: 'text' },
      { key: 'masaBerlaku', label: 'Masa Berlaku', type: 'date' },
    ],
  },
  ...
  fasilitasUmum: {
    ...
    compact: { primary: 'nama', sub: 'jarak' },
  },
  jadwalKA: {
